# Recursos & Estratégia de Quitação
...
- **Venda de Férias / Ativos**: Outras fontes de caixa.

**Como funciona:** Ao cadastrar uma renda e marcá-la como "Amortização", o Simulador de **Plano de Pagamento** recalcula automaticamente quanto tempo a menos você levará para ficar livre de dívidas.
...
> [!TIP]
> Tente manter sua capacidade de aceleração acima de 10% da sua renda familiar para uma quitação saudável e rápida.
