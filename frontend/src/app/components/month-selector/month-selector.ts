...
@Component({
 ...
 template: `
 <div class="flex items-center gap-4 bg-surface-card px-4 py-2 rounded-full shadow-sm border border-surface-border">
 <p-button icon="pi pi-chevron-left" [text]="true" [rounded]="true" (onClick)="filterService.prevMonth()"></p-button>
 
 <span class="font-bold text-color capitalize min-w-[150px] text-center select-none">
