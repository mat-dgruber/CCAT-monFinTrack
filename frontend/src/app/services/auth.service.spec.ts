...
describe('AuthService', () => {
     ...
     beforeEach(() => {
          ...
          firebaseWrapperSpy = TestBed.inject(FirebaseWrapperService) as jasmine.SpyObj<FirebaseWrapperService>;
     ...
     it('should handle auth state changes', (done) => {
          ...
          const callback = firebaseWrapperSpy.onAuthStateChanged.calls.mostRecent().args[0];
     ...
     it('should register a new user', async () => {
          ...
          firebaseWrapperSpy.createUserWithEmailAndPassword.and.resolveTo(mockCredential);
          ...
          expect(firebaseWrapperSpy.createUserWithEmailAndPassword).toHaveBeenCalledWith('test@test.com', 'pass');
          expect(firebaseWrapperSpy.updateProfile).toHaveBeenCalledWith(mockUser, { displayName: 'Test User' });
     ...
     it('should login a user', async () => {
          ...
          expect(firebaseWrapperSpy.signInWithEmailAndPassword).toHaveBeenCalledWith('test@test.com', 'pass');
          expect(result).toBe(mockCredential);
     });
