...
export class SubscriptionService {
  ...
  private prefs: Signal<UserPreference | null | undefined> = toSignal(
  ...
  getFeatureBadge(feature: Feature): {
    label: string;
    ...
    if (feature === 'credit_card_mgmt')
      return { label: 'PRO', severity: 'info' };
    if (feature === 'receipt_scanner')
      return { label: 'PRO', severity: 'info' };
