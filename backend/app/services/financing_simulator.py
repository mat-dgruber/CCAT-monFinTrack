...
class FinancingSimulator:
    ...
    @staticmethod
    def get_mcmv_defaults(
        monthly_gross_income: float, region: str = "national"
    ) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def _calculate_sac(
        principal: float, rate_monthly: float, months: int
    ) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def simulate_simulation(
        cls,
        property_value: float,
        entry_value: float,
        interest_rate_yearly: float,
        months: int,
        system: AmortizationSystem = AmortizationSystem.SAC,
    ) -> Dict[str, Any]:
